...
public class CentralOld extends LinearOpMode{
    //-------------------SUBCLASS VARIABLES----------------------
    ...
    protected static final float startX = -2; // may need change based on field
    ...
    public enum setupType{
        all, glyph, jewel, relic, drive, teleop, notjewel, blue1;
    }
    public enum team{
    ...
    public static final String motorFRS = "rack";
    ...
    public void  runOpMode() throws InterruptedException{
        CentralClass(setupType.all, team.none);
    }
    ...
    public void driveTrainMovementAccelerate(double speed, movements movement) throws InterruptedException{
        double[] signs = movement.getDirections();
