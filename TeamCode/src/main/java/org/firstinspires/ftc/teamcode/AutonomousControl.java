...
public abstract class AutonomousControl extends Central {
    ...
    public float[][] GetVufPos()
    {
        ...
        if (targetVisible) {
            ...
            float[][] retVal = {{translation.get(0), translation.get(1), translation.get(2)}, {rotation.firstAngle, rotation.secondAngle, rotation.thirdAngle}};
            return retVal;
        }
        else {
            return null;
